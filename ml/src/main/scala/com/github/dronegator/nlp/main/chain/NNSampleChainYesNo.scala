...
import com.github.dronegator.nlp.main.chain.NNSampleChainYesNo.{Hidden, Network, Quality}
...
case class NNChainYesNoImpl(network: Network, nKlassen: Int)
  extends NNChainYesNo {
...
class NNSampleChainYesNo(val nKlassen: Int,
                         nToken: Int,
                         dropout: Int,
